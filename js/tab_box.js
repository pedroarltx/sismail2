...
// Para o contato do condutor:
toggleOcorrencia('contato_condutor', 'ocorrencia_motorista');

// Para o contato do responsável:
toggleOcorrencia('contato_responsavel', 'ocorrencia_responsavel');

// Para o contato do policial:
toggleOcorrencia('contato_policial', 'ocorrencia_policial');
